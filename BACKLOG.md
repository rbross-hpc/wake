...
| — | `classify-4` description-only + required, non-destructive re-resolve | [build log](docs/build-log.md) — v0.4.23, design record in `PLAN.md` |
| — | Packaged `classify` model default switched to Claude Haiku 4.5 | [build log](docs/build-log.md) — v0.4.24 |
| — | `__version__` derived from package metadata (was hardcoded `"0.1.0"`) | [build log](docs/build-log.md) — v0.4.25 |
